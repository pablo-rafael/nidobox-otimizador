...
* **Hospedagem / Cloud:** [Render.com](https://nidobox-otimizador.onrender.com/)
...
```text
/nidobox-otimizador
│── app.py                 # API e rotas do servidor Flask
│── otimizador.py          # Motor matemático de Pesquisa Operacional (PuLP + Pandas)
│── requirements.txt       # Dependências do projeto e controle de versões
└── /templates
    └── index.html         # Interface do usuário (Formulário e Dashboard)
